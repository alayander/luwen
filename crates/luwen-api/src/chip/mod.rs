...
pub struct Telemetry {
    ...
    pub fw_build_date: u32,
    pub enabled_tensix_row: u32,
    pub therm_trip_count: u32,
    pub asic_id_high: u32,
    pub asic_id_low: u32,
    pub aiclk_limit_max: u32,
    pub tdp_limit_max: u32,
    pub aiclk_arb_min: u32,
    pub aiclk_arb_max: u32,
    pub enabled_min_arb: u32,
    pub enabled_max_arb: u32,
    pub aiclk_ppm_info: u32,
    pub host_aiclk_limit: u32,
    pub gddr_io_west_current: u32,
    pub gddr_io_east_current: u32,
}
